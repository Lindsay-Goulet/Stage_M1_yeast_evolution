...
for rp in 1 3 6
do
	./smc++ estimate $mu EGR/files/neutral_model_$rep.smc.gz -o EGR/EGR_$knots/results/cubic/rp$rp --base $rep --knots $knots --timepoints 0 10000 --spline cubic -rp $rp
	./smc++ plot EGR/EGR_$knots/plot/cubic/rp$rp/plot_model_$rep.png EGR/EGR_$knots/results/cubic/rp$rp/$rep.final.json --csv
	./smc++ estimate $mu EGR/files/neutral_model_$rep.smc.gz -o EGR/EGR_$knots/results/piecewise/rp$rp --base $rep --knots $knots --timepoints 0 10000 --spline piecewise -rp $rp
